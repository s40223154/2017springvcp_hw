...
利用漸開線原理, 以 Brython 繪製單(17t-11t-13t)正齒輪廓:

第1齒輪從順時鐘轉 90 度之後, 必須配合目前的標記線所作
地2齒要配合第一齒逆時針90度之後要在+上原本的一齒所以(-90*deg-math.pi/n11)
第3齒要配合第2齒+原本一齒(-90*deg-math.pi/n13)之後再配合第一齒+上半圈扣掉第一齒輪的1齒在乘上n11/n13(180*deg-math.pi/n11)*n11/n13)
